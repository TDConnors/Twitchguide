	...
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new StyleBundle("~/Content/css").Include(
					  ...
					  "~/Content/Theme/assets/js/gritter/css/jquery.gritter0.css",
					  "~/Content/site.css"
					  ));
        ...
        "~/Content/Theme/assets/js/jquery.backstretch.min.js"
        ));
			bundles.Add(new StyleBundle("~/Content/loginTheme").Include(
				"~/Content/_loginTheme/bootstrap.css",
				"~/Content/_loginTheme/font-awesome.css",
				"~/Content/_loginTheme/style.css",
				"~/Content/_loginTheme/style-responsive.css",
                "~/Content/site.css"
        ));
